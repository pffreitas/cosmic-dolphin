...
**Vulnerability:** Fastify CORS plugin was configured with `origin: true`, allowing any domain to access the API.
**Learning:** Using `origin: true` disables CORS protection entirely.
**Prevention:** Always restrict CORS to specific trusted origins using environment variables.
